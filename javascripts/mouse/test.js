!function () {
  ...
  function l() {
    ...
    return {l: w, z: o(v, "zIndex", -1), o: o(v, "opacity", 0.6), c: o(v, "color", "0,0,0"), n: o(v, "count", 99)}
  }
      ...
      for (v = 0; v < w.length; v++) {
        ...
        if (i !== x && null !== x.x && null !== x.y) {
          ...
          y < x.max && (x === f && y >= x.max / 2 && (i.x -= 0.03 * B, i.y -= 0.03 * z), A = (x.max - y) / x.max, e.beginPath(),
            e.lineWidth = A / 2, e.strokeStyle = "red", e.moveTo(i.x, i.y), e.lineTo(x.x, x.y), e.stroke())
